...
class PUR_Plugin {
	public function __construct() {
		...
		require_once PUR_PATH . 'includes/class-pur-rhr-options.php';
	}
	...
	public function after_setup_theme() {
		...
		require_once PUR_PATH . 'includes/class-pur-forced-login-frontend.php';
		new pur_forced_login_frontend();
		
		require_once PUR_PATH . 'includes/class-pur-login-whitelist-frontend.php';
		new PurLoginWhiteListFrontend();
		
		require_once PUR_PATH . 'includes/class-pur-wp-admin-access.php';
