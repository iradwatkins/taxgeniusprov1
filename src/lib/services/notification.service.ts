...
export class NotificationService {
  ...
  private static async sendInApp(userId: string, notification: any): Promise<void> {
  ...
  private static async sendEmail(userId: string, notification: any): Promise<void> {
  ...
  private static async sendPush(userId: string, notification: any): Promise<void> {
