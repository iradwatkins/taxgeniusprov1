    ...
    return (
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardTitle className="text-2xl text-center">Welcome to Tax Genius Referral Program!</CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="bg-muted p-6 rounded-lg space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Check your email <strong>({formData.email})</strong> in the next 5 minutes</li>
          ...
          <div className="bg-green-50 dark:bg-green-950/20 p-6 rounded-lg border-2 border-green-500">
            ...
            <p className="text-sm">You'll get an EXTRA $25 for your first 3 referrals! That's $75 each!</p>
          </div>
