...
export const metadata = {
  ...
  description: 'Join Tax Genius Referral Program! Earn $50+ for every client you refer. No experience needed. Get paid weekly. Start earning today!',
};
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
              EARN <span className="text-yellow-300">$50+</span><br />
              FOR EVERY PERSON<br />
              YOU REFER!
            </h1>
            ...
            {[
              {
                number: "1",
                title: "Sign Up Free",
                description: "Fill out the quick form (takes 2 minutes). Get your unique referral link instantly.",
                icon: "📝"
              },
              {
                number: "2",
                title: "Share Your Link",
                description: "Post on Facebook, Instagram, text friends, email family. Share your link anywhere!",
                icon: "📱"
              },
              {
                number: "3",
                title: "Get Paid",
                description: "When someone uses your link and files their taxes, you get paid $50+. It's that simple!",
                icon: "💰"
              }
            ].map((step, i) => (
              <div key={i} className="bg-card border-2 border-primary/20 rounded-xl p-8 text-center hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">Make money without doing any actual tax work!</p>
          </div>
            ...
            {[
              {
                ...
                description: "Get paid $50 for every person who files their taxes through your link. The more you share, the more you earn!"
              },
              {
                icon: Users,
                title: "Easy to Share",
                description: "Everyone needs to do their taxes! Your friends, family, coworkers - they all qualify. Share everywhere!"
              },
              {
                icon: Gift,
                title: "Bonus Rewards",
                description: "Refer 10+ people? Get BONUS $100. Refer 25+? Get BONUS $300. Top referrer each month wins $1,000!"
              },
              {
                icon: TrendingUp,
                title: "Passive Income",
                description: "Once you share your link, it works 24/7. Make money while you sleep, eat, or watch TV!"
              },
              {
                icon: CheckCircle,
                title: "No Sales Skills Needed",
                description: "You're not selling anything. Just share your link. We handle everything else. Super simple!"
              },
              {
                icon: Star,
                title: "Weekly Payouts",
                description: "Get paid every week via direct deposit, PayPal, or Cash App. Fast and reliable payments!"
              }
            ].map((benefit, i) => (
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-2 border-green-500 rounded-xl p-8 text-center">
          ...
          <div className="text-center mt-12 bg-yellow-50 dark:bg-yellow-950/20 border-2 border-yellow-400 rounded-xl p-8">
            <p className="text-2xl font-bold mb-4">🎉 Top referrers are making $5,000+ per month!</p>
            ...
            {[
              {
                ...
                quote: "I just posted my link on Facebook and Instagram. I didn't even try that hard and made over $3,000! This is the easiest money I've ever made."
              },
              {
                name: "Marcus T.",
                earnings: "$1,850 in 2 weeks",
                quote: "I told my coworkers about it and they all signed up. Then they told their friends. I'm making money from people I don't even know!"
              },
              {
                name: "Lisa R.",
                earnings: "$5,100 this year",
                quote: "I share my link once a month on my Facebook page. That's it. $5,100 for posting a link a few times. Absolutely worth it!"
              },
              {
                name: "David K.",
                earnings: "$890 first month",
                quote: "I was skeptical but figured I'd try it. Made almost $900 my first month just texting people. Now I tell everyone!"
              }
            ].map((testimonial, i) => (
              <div key={i} className="bg-card border rounded-xl p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 dark:text-green-400 font-semibold">{testimonial.earnings}</p>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            READY TO START MAKING EASY MONEY?
          </h2>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 mb-8">
            ...
            <p className="text-xl font-bold">⚡ BONUS ENDS SOON! Sign up now to get $25 for your first 3 referrals!</p>
          </div>

          <Link href="/referral/signup">
            <Button size="lg" className="h-16 px-12 text-xl font-bold bg-yellow-400 text-black hover:bg-yellow-500 mb-8">
