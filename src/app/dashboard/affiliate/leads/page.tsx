      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track and manage your affiliate leads
          </p>
        </div>
        <Button>
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {leads.filter(l => l.status === 'New').length} ({Math.round((leads.filter(l => l.status === 'New').length / leads.length) * 100)}%)
                  </span>
                </div>
                <div className="h-6 bg-muted rounded-lg overflow-hidden">
                  <div
                    className="h-full bg-yellow-600 flex items-center px-2 text-white text-xs font-medium"
                    style={{ width: `${(leads.filter(l => l.status === 'New').length / leads.length) * 100}%` }}
                  >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {leads.filter(l => l.status === 'Contacted').length} ({Math.round((leads.filter(l => l.status === 'Contacted').length / leads.length) * 100)}%)
                  </span>
                </div>
                <div className="h-6 bg-muted rounded-lg overflow-hidden">
                  <div
