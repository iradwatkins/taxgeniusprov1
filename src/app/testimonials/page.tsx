...
export const metadata: Metadata = {
  ...
  description: 'Read what our clients say about our professional tax preparation services. Trusted by thousands of individuals and businesses.',
}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Don't just take our word for it. Here's what real clients have to say about their experience with TaxGeniusPro.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-12">
              Why Clients Trust TaxGeniusPro
            </h2>
