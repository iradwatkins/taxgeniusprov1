              ...
              {[
                {
                  ...
                  description: "Our certified tax preparers have years of experience handling complex tax situations."
                },
                {
                ...
                },
                {
                  ...
                  description: "Bank-level encryption protects your sensitive financial information."
                },
                {
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-primary/5 border-0">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied clients who trust Tax Genius with their tax preparation needs.
              </p>
